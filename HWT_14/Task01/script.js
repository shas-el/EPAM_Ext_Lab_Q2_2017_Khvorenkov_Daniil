//todo pn это, конечно, здорово, что у тебя получилось выполнить задание, но желательно, чтобы интуитивно было понятно, что делать пользователю. Пасхалки на сайтах - вещи веселые, но исключительно для развлечения и не должны как-то ущемлять основной функционал сайта. В твоём случае - повесить изменение текста на mouse over - один из самых худших сценариев.
